...
int main() {
    ...
    std::cout << "\nTest 2: Graphics creation with threading enabled..." << std::endl;
    {
        ...
        std::cout << "  Node has SceneGraph: " 
                  << (node->getSceneGraph() != nullptr ? "yes" : "no") << std::endl;
    ...
    std::cout << "\nTest 3: Independent threading per SceneGraph..." << std::endl;
    {
        ...
        std::cout << "  SG1 root has SG1: " << (node1->getSceneGraph() == &sg1 ? "yes" : "no") << std::endl;
        std::cout << "  SG2 root has SG2: " << (node2->getSceneGraph() == &sg2 ? "yes" : "no") << std::endl;
    }
