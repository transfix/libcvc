...
public:
    ...
    explicit state_list(state& node,
                        std::size_t pad_width = default_pad_width);
    ...
    public:
        ...
        iterator() = default;
        iterator(state_list* list, std::size_t pos)
            : _list(list), _pos(pos) {}
        ...
        iterator  operator++(int) { auto tmp = *this; ++_pos; return tmp; }
        iterator& operator--()    { --_pos; return *this; }
        iterator  operator--(int) { auto tmp = *this; --_pos; return tmp; }
        ...
        difference_type operator-(const iterator& o) const {
            return static_cast<difference_type>(_pos) -
                   static_cast<difference_type>(o._pos);
        }
