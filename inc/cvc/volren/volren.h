// Umbrella header for cvc::volren, the software raycast volume renderer.
// See docs/VOLREN_API.md.
#ifndef CVC_VOLREN_VOLREN_H
#define CVC_VOLREN_VOLREN_H
