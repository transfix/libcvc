...
TEST_F(NullGraphicNodeTest, SyncBoundsToChildrenSingleChild) {
    ...
    geom.points()[0][0] = 0; geom.points()[0][1] = 0; geom.points()[0][2] = 0;
    geom.points()[1][0] = 10; geom.points()[1][1] = 0; geom.points()[1][2] = 0;
    geom.points()[2][0] = 10; geom.points()[2][1] = 10; geom.points()[2][2] = 0;
    geom.points()[3][0] = 0; geom.points()[3][1] = 10; geom.points()[3][2] = 0;
    geom.points()[4][0] = 0; geom.points()[4][1] = 0; geom.points()[4][2] = 10;
    geom.points()[5][0] = 10; geom.points()[5][1] = 0; geom.points()[5][2] = 10;
    geom.points()[6][0] = 10; geom.points()[6][1] = 10; geom.points()[6][2] = 10;
    geom.points()[7][0] = 0; geom.points()[7][1] = 10; geom.points()[7][2] = 10;
...
TEST_F(NullGraphicNodeTest, SyncBoundsToChildrenMultipleChildren) {
    ...
    geom1.points()[0][0] = -5; geom1.points()[0][1] = -5; geom1.points()[0][2] = -5;
    geom1.points()[1][0] = 0; geom1.points()[1][1] = 0; geom1.points()[1][2] = 0;
    sceneGraph.addGraphics("geom1", geom1);
    
    // Add second geometry
    cvc::geometry geom2;
    geom2.points().resize(2);
    geom2.points()[0][0] = 0; geom2.points()[0][1] = 0; geom2.points()[0][2] = 0;
    geom2.points()[1][0] = 15; geom2.points()[1][1] = 20; geom2.points()[1][2] = 25;
...
TEST_F(NullGraphicNodeTest, TransformPropagationToChildren) {
    ...
    geom.points().resize(2);
    geom.points()[0][0] = 0; geom.points()[0][1] = 0; geom.points()[0][2] = 0;
    geom.points()[1][0] = 2; geom.points()[1][1] = 2; geom.points()[1][2] = 2;
...
TEST_F(NullGraphicNodeTest, TransformAffectsCombinedBounds) {
    ...
    geom.points().resize(2);
    geom.points()[0][0] = 0; geom.points()[0][1] = 0; geom.points()[0][2] = 0;
    geom.points()[1][0] = 1; geom.points()[1][1] = 1; geom.points()[1][2] = 1;
    sceneGraph.addGraphics("geom1", geom);
...
TEST_F(NullGraphicNodeTest, SyncBoundsRespectsChildTransforms) {
    ...
    cvc::geometry geom1;
    geom1.points().resize(2);
    geom1.points()[0][0] = 0; geom1.points()[0][1] = 0; geom1.points()[0][2] = 0;
    geom1.points()[1][0] = 1; geom1.points()[1][1] = 1; geom1.points()[1][2] = 1;
    ...
    geom2.points().resize(2);
    geom2.points()[0][0] = 0; geom2.points()[0][1] = 0; geom2.points()[0][2] = 0;
    geom2.points()[1][0] = 1; geom2.points()[1][1] = 1; geom2.points()[1][2] = 1;
