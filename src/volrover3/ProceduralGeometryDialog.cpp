...
ProceduralGeometryDialog::ProceduralGeometryDialog(ProceduralGeometryType type,
    ...
    , m_centerYSpinBox(nullptr)
    , m_centerZSpinBox(nullptr)
    , m_radiusSpinBox(nullptr)
    , m_thetaResSpinBox(nullptr)
    , m_phiResSpinBox(nullptr)
    , m_sizeXSpinBox(nullptr)
    , m_sizeYSpinBox(nullptr)
    , m_sizeZSpinBox(nullptr)
    , m_majorRadiusSpinBox(nullptr)
    , m_minorRadiusSpinBox(nullptr)
    , m_majorResSpinBox(nullptr)
    , m_minorResSpinBox(nullptr)
    , m_coneRadiusSpinBox(nullptr)
    , m_coneHeightSpinBox(nullptr)
    , m_coneResSpinBox(nullptr)
    , m_coneCapResSpinBox(nullptr)
    , m_buttonBox(nullptr)
{
    setupUI();
}
...
void ProceduralGeometryDialog::setupUI()
{
    QString title;
    switch (m_type) {
        case ProceduralGeometryType::Sphere: title = tr("Generate Sphere"); break;
        case ProceduralGeometryType::Cube: title = tr("Generate Cube"); break;
        case ProceduralGeometryType::Torus: title = tr("Generate Torus"); break;
        case ProceduralGeometryType::Cone: title = tr("Generate Cone"); break;
    }
...
void ProceduralGeometryDialog::generateTorus()
{
    ...
    // Use the algorithm function to generate the geometry
    cvc::geometry geom = cvc::generate_torus(cx, cy, cz, majorRadius, minorRadius, majorRes, minorRes);
