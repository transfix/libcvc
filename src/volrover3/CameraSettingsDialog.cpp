...
CameraSettingsDialog::CameraSettingsDialog(const CameraSettings& settings, 
                                           cvc::state* cameraState,
                                           QWidget *parent)
    : QDialog(parent)
    , m_cameraState(cameraState)
    , m_stateTable(nullptr)
{
    ...
    connect(m_modeCombo, QOverload<int>::of(&QComboBox::currentIndexChanged),
            this, &CameraSettingsDialog::emitSettingsChanged);
    connect(m_flySpeedSpin, QOverload<double>::of(&QDoubleSpinBox::valueChanged),
            this, &CameraSettingsDialog::emitSettingsChanged);
    connect(m_mouseSensitivitySpin, QOverload<double>::of(&QDoubleSpinBox::valueChanged),
            this, &CameraSettingsDialog::emitSettingsChanged);
    connect(m_invertMouseCheck, &QCheckBox::toggled,
            this, &CameraSettingsDialog::emitSettingsChanged);
    connect(m_keyForwardButton, &KeyBindButton::keyChanged,
            this, &CameraSettingsDialog::emitSettingsChanged);
    connect(m_keyBackwardButton, &KeyBindButton::keyChanged,
            this, &CameraSettingsDialog::emitSettingsChanged);
    connect(m_keyStrafeLeftButton, &KeyBindButton::keyChanged,
            this, &CameraSettingsDialog::emitSettingsChanged);
    connect(m_keyStrafeRightButton, &KeyBindButton::keyChanged,
            this, &CameraSettingsDialog::emitSettingsChanged);
    connect(m_keyUpButton, &KeyBindButton::keyChanged,
            this, &CameraSettingsDialog::emitSettingsChanged);
    connect(m_keyDownButton, &KeyBindButton::keyChanged,
            this, &CameraSettingsDialog::emitSettingsChanged);
    
    // Subscribe to camera state changes if provided
    if (m_cameraState) {
        m_stateConnection = m_cameraState->childChanged.connect(
...
{
    if (!m_cameraState || !m_stateTable) return;
