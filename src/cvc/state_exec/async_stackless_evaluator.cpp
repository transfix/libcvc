...
evaluator_state async_stackless_evaluator::create_state(
...
task<value_t> async_stackless_evaluator::run(
...
value_t async_stackless_evaluator::sync_evaluate(
    const value_t& expr, environment_ptr env,
    std::optional<double> timeout_sec,
    std::function<void(const value_t&)> on_complete)
{
...
value_t async_stackless_evaluator::sync_evaluate_script(
    const std::string& script, environment_ptr env,
    std::optional<double> timeout_sec,
    std::function<void(const value_t&)> on_complete)
{
