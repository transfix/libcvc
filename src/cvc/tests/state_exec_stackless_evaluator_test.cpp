...
TEST_F(StacklessEvaluatorTest, IntegerLiteral) {
    EXPECT_EQ(eval_int("42"), 42);
}

TEST_F(StacklessEvaluatorTest, DoubleLiteral) {
    EXPECT_DOUBLE_EQ(eval_double("3.14"), 3.14);
}

TEST_F(StacklessEvaluatorTest, StringLiteral) {
    EXPECT_EQ(eval_string("\"hello\""), "hello");
}

TEST_F(StacklessEvaluatorTest, NilLiteral) {
    EXPECT_TRUE(eval("nil").is_nil());
}

TEST_F(StacklessEvaluatorTest, TrueLiteral) {
    EXPECT_TRUE(eval_bool("t"));
}

// ─── Arithmetic ────────────────────────────────────────────────────────────

TEST_F(StacklessEvaluatorTest, Addition) {
    EXPECT_EQ(eval_int("(+ 1 2 3)"), 6);
}

TEST_F(StacklessEvaluatorTest, Subtraction) {
...
TEST_F(StacklessEvaluatorTest, IfTrue) {
    EXPECT_EQ(eval_int("(if t 1 2)"), 1);
}

TEST_F(StacklessEvaluatorTest, IfFalse) {
    EXPECT_EQ(eval_int("(if nil 1 2)"), 2);
}

TEST_F(StacklessEvaluatorTest, Begin) {
    EXPECT_EQ(eval_int("(begin 1 2 3)"), 3);
}

TEST_F(StacklessEvaluatorTest, Set) {
...
TEST_F(StacklessEvaluatorTest, MaxSteps) {
    ...
    auto state = ev->create_state(
        std::string("(begin (set i 0) (while (< i 1000) (set i (+ i 1))) i)"));
...
TEST_F(StacklessEvaluatorTest, Eval) {
